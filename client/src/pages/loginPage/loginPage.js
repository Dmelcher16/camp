          ...
          <Container id="about-container" fluid>
            <Row className="align-items-center">
              ...
              <Col className="about-col">
                ...
                <p className="h4">
                  {" "}
                  Our application allows trainers to create and maintain data of
                  the progress they are making with each dog under their care,
                  and provide up-to-date information to their clients.
                </p>
              </Col>
            </Row>
          </Container>
          ...
          <Container id="about-container" fluid>
            <Row className="align-items-center">
              ...
              <Col className="about-col">
                ...
                <p className="h4">
                  Your training data is displayed in coherent graphs so you can
                  easily visualize where progress is being made, and where there
                  are opportunites for improvement.
                </p>
                <br />
                <p className="h4">
